 ...
 *
 * BAI Work sets a new app name early so userData, notifications, tray
 * labels, and default window titles agree with the productName.
 */
export const APP_PRODUCT_NAME = 'BAI Work'
