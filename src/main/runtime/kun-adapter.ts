...
import { baiWorkRuntimeAdapter } from './bai-work-adapter'
...
export const kunRuntimeAdapter: ManagedRuntimeAdapter = baiWorkRuntimeAdapter

export function managedRuntimeAdapterForSettings(settings: AppSettingsV1): ManagedRuntimeAdapter {
  void settings
  return baiWorkRuntimeAdapter
}
...
/** Build the bearer-token authorization header for the local BAI Work runtime. */
