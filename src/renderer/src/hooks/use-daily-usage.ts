...
type RawDailyUsageBucket = {
  ...
  cache_telemetry_available?: unknown
  token_economy_telemetry_available?: unknown
  turns?: unknown
...
function normalizeBucket(raw: RawDailyUsageBucket): DailyUsageBucket {
  ...
  return {
    ...
    cacheTelemetryAvailable: usageTelemetryFlag(raw.cache_telemetry_available, usageRate(raw.cache_hit_rate) !== null),
    tokenEconomyTelemetryAvailable: usageTelemetryFlag(
      raw.token_economy_telemetry_available,
      typeof raw.token_economy_savings_tokens === 'number'
    ),
...
function normalizeTotals(raw: RawDailyUsageBucket & { days?: unknown; active_days?: unknown }): DailyUsageTotals {
  ...
  return {
    ...
    cacheTelemetryAvailable: bucket.cacheTelemetryAvailable,
    tokenEconomyTelemetryAvailable: bucket.tokenEconomyTelemetryAvailable,
    turns: bucket.turns,
