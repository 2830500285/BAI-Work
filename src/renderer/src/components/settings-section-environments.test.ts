...
const labels: Record<string, string> = {
  ...
  environmentsDesc: 'Local environments tell BAI Work how to prepare workspaces and worktrees for a project.',
  ...
  it('renders saved environment projects and their setup command', () => {
    const html = renderToStaticMarkup(createElement(EnvironmentsSettingsSection, {
      ctx: {
        t,
        form: {
          workspaceRoot: '/Users/mac/Documents/BAI Work/BAI-Work-Shell',
          environmentProjects: [
            {
              path: '/Users/mac/Documents/BAI Work/BAI-Work-Shell',
    ...
    expect(html).toContain('BAI-Work-Shell')
    expect(html).toContain('/Users/mac/Documents/BAI Work/BAI-Work-Shell')
