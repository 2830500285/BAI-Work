...
describe('SidebarProjectsSection groups', () => {
  ...
  it('hides the default chat workspace while filtering write workspaces from code project groups', () => {
    const groups = buildSidebarWorkspaceGroups({
      threads: [
        ...
        thread({ id: 'default-code', workspace: '/Users/zxy/.bai-work/default_workspace' }),
        thread({ id: 'legacy-default-code', workspace: '/Users/zxy/.mimo-work/default_workspace' }),
        thread({ id: 'write-assistant', workspace: '~/.bai-work/write_workspace' })
      ],
      searchQuery: '',
      showArchived: false,
      workspaceRoot: '/Users/zxy/project-a',
  ...
  it('shows default workspace threads in the chat section instead of projects', () => {
    const chats = buildSidebarChatThreads({
      threads: [
        thread({ id: 'code-current', workspace: '/Users/zxy/project-a' }),
        thread({ id: 'default-code', workspace: '/Users/zxy/.bai-work/default_workspace' }),
        thread({ id: 'default-short', workspace: '~/BAI Work/default_workspace' }),
        thread({ id: 'legacy-default', workspace: '~/.mimo-work/default_workspace' }),
        thread({ id: 'write-assistant', workspace: '~/.bai-work/write_workspace' })
      ],
      searchQuery: '',
      showArchived: false
  ...
  it('does not create a project group for default workspace aliases', () => {
    const groups = buildSidebarWorkspaceGroups({
      threads: [
        thread({ id: 'default-short', workspace: '~/.bai-work/default_workspace' }),
        thread({ id: 'default-absolute', workspace: 'C:\\Users\\zxy\\.bai-work\\default_workspace' }),
        thread({ id: 'legacy-default', workspace: 'C:\\Users\\zxy\\.mimo-work\\default_workspace' })
      ],
      searchQuery: '',
      showArchived: false,
      workspaceRoot: 'C:\\Users\\zxy\\.bai-work\\default_workspace',
      workspaceRoots: [
