...
/** Keyed by provider profile id (bai, custom profiles, ...). */
...
const DEFAULT_INITIAL_SETUP_PRESET_ID = 'bai'
...
/** Card and mode to preselect: the active BAI provider by default. */
export function initialSetupSelection(settings: AppSettingsV1): InitialSetupSelection {
  ...
  return { presetId: DEFAULT_INITIAL_SETUP_PRESET_ID, mode: 'api' }
}
