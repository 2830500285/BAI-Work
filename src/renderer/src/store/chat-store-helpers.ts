...
const LEGACY_CODE_WORKSPACE_ROOTS_STORAGE_KEYS = ['kun.codeWorkspaceRoots.v1']
...
export function readCodeWorkspaceRoots(): string[] {
  clearLegacyCodeWorkspaceRootsStorage()
  try {
...
function clearLegacyCodeWorkspaceRootsStorage(): void {
  for (const key of LEGACY_CODE_WORKSPACE_ROOTS_STORAGE_KEYS) {
