...
function channel(overrides: Partial<ClawImChannelV1> = {}): ClawImChannelV1 {
  ...
  return {
    ...
    workspaceRoot: '/Users/zxy/.bai-work/claw/agent01',
    agentProfile: {
      name: '',
      description: '',
      identity: '',
    ...
    conversations: [
      {
        ...
        workspaceRoot: '/Users/zxy/.bai-work/claw/agent01/conversations/chat-1',
        createdAt: now,
        updatedAt: now
      }
    ],
...
function thread(id: string, title: string, updatedAt = '2026-06-01T00:00:00.000Z'): NormalizedThread {
  return {
    ...
    model: 'reasonix',
    mode: 'agent',
    workspace: '/Users/zxy/.bai-work/default_workspace'
  }
}
  ...
  it('recovers an unmapped Claw managed Kun session before creating a new empty one', () => {
    ...
    const recovered = findRecoverableClawThread(
      [
        ...
        thread('old-content-thread', `${CLAW_MANAGED_INSTRUCTIONS_HEADING} BAI Work scheduled-task tools`, '2026-06-01T00:01:00.000Z')
      ],
      [item],
      item
    )
