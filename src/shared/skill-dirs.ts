...
export const COMMON_GLOBAL_SKILL_DIRS: readonly CommonSkillDir[] = [
  ...
  { id: 'global-hermes', scope: 'global', relativePath: '.hermes/skills', labelKey: 'pluginSkillRootGlobalHermes' },
  { id: 'global-bai-code', scope: 'global', relativePath: '.bai/skills', labelKey: 'pluginSkillRootGlobalBaiCode' },
  { id: 'global-bai-work', scope: 'global', relativePath: '.bai-work/skills', labelKey: 'pluginSkillRootGlobalMimoWork' }
]
