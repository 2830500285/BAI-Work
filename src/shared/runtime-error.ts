/**
 * Shared parser for BAI Work runtime error bodies.
 *
 * The local adapter returns `{ code, message, details? }`.
 * Older code paths may also surface
 ...
 * part of the adapter schema). `details` carries the original
