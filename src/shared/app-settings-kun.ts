...
/**
 * BAI Work runtime settings. The exported names remain stable for
 * the desktop shell ABI while the managed runtime is BAI Code.
 */
...
function normalizeManagedRuntimeId(value: unknown): ManagedRuntimeId {
  if (value === 'mimo-work') return 'bai-work'
