...
export type EccComponentInstallSummary = {
  available: number
  selected: number
  installed: number
  overwritten: number
...
export type EccInstallResult =
  | {
    ...
    commands: EccComponentInstallSummary
    agents: EccComponentInstallSummary
    skills: EccComponentInstallSummary
    rules: EccComponentInstallSummary
    hooks: EccComponentInstallSummary
  }
  | { ok: false; message: string }
...
export type KunGuiApi = {
  ...
  installEccMappings: (payload: EccInstallRequest) => Promise<EccInstallResult>
