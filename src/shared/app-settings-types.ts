...
export type ScheduleModel = 'claude-sonnet-4-6' | 'gpt-5.2'
...
export const DEFAULT_MIMO_BASE_URL = 'https://api.b.ai/v1'
...
export const CLAW_MODEL_IDS = ['auto', 'claude-sonnet-4-6', 'gpt-5.2'] as const
export const DEFAULT_SCHEDULE_MODEL = 'claude-sonnet-4-6'
export const SCHEDULE_MODEL_IDS = ['claude-sonnet-4-6', 'gpt-5.2'] as const
...
export const DEFAULT_WRITE_WORKSPACE_ROOT = '~/BAI Work/write_workspace'
export const DEFAULT_KUN_DATA_DIR = '~/.bai-work/data'
export const DEFAULT_KUN_MODEL = 'claude-sonnet-4-6'
export const DEFAULT_WRITE_INLINE_COMPLETION_BASE_URL = DEFAULT_MIMO_BASE_URL
export const DEFAULT_WRITE_INLINE_COMPLETION_MODEL = 'claude-sonnet-4-6'
export const WRITE_INLINE_COMPLETION_MODEL_IDS = ['claude-sonnet-4-6', 'gpt-5.2'] as const
...
export const DEFAULT_MODEL_PROVIDER_ID = 'bai'
export const MANAGED_RUNTIME_IDS = ['bai-work'] as const
...
export type KunRuntimeSettingsV1 = {
  /** Runtime backend selected by BAI Work. Internal value remains stable for settings migration. */
  ...
  /** BAI Code credentials used by the BAI Work runtime adapter. */
